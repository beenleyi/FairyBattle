...
void selectOpponentForm::on_upgradeBattle_pushButton_clicked(){
    ...
    *myFairyInfoObject=ui->userFairies_comboBox->currentData().toJsonObject();
    QJsonObject *opponentFairyInfoObject=new QJsonObject;
    *opponentFairyInfoObject=ui->serverFairies_comboBox->currentData().toJsonObject();
...
void selectOpponentForm::showBattleFairy(QJsonObject* battleFairiesBag){
    ui->serverFairies_comboBox->clear();
...
void selectOpponentForm::on_return_pushButton_clicked(){
